...
namespace GameBench
{
    public class SpinWheel : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            chunkSp[0] = SpinWheelManager.Instance.chunkSp[index];
            pointSp[0] = SpinWheelManager.Instance.dotSp[index];
            circleBorderSp = SpinWheelManager.Instance.circleBorderSp[index];
            arrowBgSp = SpinWheelManager.Instance.arrowSp[index];
            SetupWheel();
        ...
        public void StartSpin()
        {
            if (!spinning)
            {
                ...
                StartCoroutine(SpinTheWheel(5.5f * randomTime, maxAngle));
            }
        }
        ...
        void RewardPlayer()
        {
            ...
            SpinWheelManager.Instance.SpinCompleted(SelectedReward);
            /*if (SpinWheelSetup.Instance.rewarItem[SelectedReward].rewardType == RewardType.Coin)
            {
                SpinWheelManager.Instance.ManipulateCoins(SpinWheelSetup.Instance.rewarItem[SelectedReward].rewardQuantity);
            }*/
        }
